...
class DriverHome extends Component {
  ...
  onFind(place) {
    ...
    region = {
      ...
      latitudeDelta:
        place === 'pharmacy' ? 0.05 : place === 'hospitals' ? 0.0005 : 0.0005,
      longitudeDelta:
        place === 'pharmacy' ? 0.05 : place === 'hospitals' ? 0.0005 : 0.0005,
    };
    ...
    this.setState({
      region: {
        ...
        longitude: this.state.region.longitude,
        latitudeDelta:
          place === 'pharmacy' ? 0.05 : place === 'hospitals' ? 0.15 : 0.15,
        longitudeDelta:
          place === 'pharmacy' ? 0.05 : place === 'hospitals' ? 0.15 : 0.15,
      },
    });
  ...
  onRequest() {
    ...
    this.props.navigation.navigate('DonorRequest', {
                  ...
                  {!submitRatings ? (
                    <View style={{flexDirection: 'row', paddingLeft: 10}}>
                      <Image
                        source={
                          userDetails.image !== ''
                            ? {uri: 'data:image/jpeg;base64,' + receiver.image}
                      ...
                      <View style={{marginLeft: 20, paddingTop: 10}}>
                        ...
                        <Text style={{color: '#ff5d5b', fontSize: 14}}>
                          Number of Bottles: {receiver.numberOfBottles}
                        </Text>
                      </View>
                    </View>
                  ) : (
                  ...
                  <View
                    ...
                    <Button
                      ...
                      onPress={() =>
                        !accepted
                          ? this.onAccept()
                          : Communications.phonecall(receiver.phoneNo, true)
                      }>
