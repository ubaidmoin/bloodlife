...
class BecomeDonor extends Component {
  ...
  becomeDonor() {
    ...
    } else if (this.state.disease === 'Yes') {
      alert('Sorry, diseased person can not donate blood.');
      this.setState({
        loading: false,
      });
    } else if (years < 18) {
      ...
      <KeyboardAvoidingView style={container}>
        <ScrollView
          ...
          <TextInput
            ...
            selectionColor="#ff5d5b"
            underlineColor="#ff5d5b"
            value={moment(this.props.userDetails.dob).format('DD/MM/yyyy')}
            disabled
          />
          <TextInput
            label="Address"
